 ...
 */
final class Version20241118182015 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE order_items ADD order_id INT NOT NULL, CHANGE total total NUMERIC(10, 2) NOT NULL');
